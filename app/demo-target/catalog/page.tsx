...
export default function DemoCatalog() {
  return <main style={{ maxWidth: 720, margin: "48px auto", fontFamily: "Arial, sans-serif" }}>
    ...
    <p style={{ color: "#999", background: "#fff" }}>Filter by color, fit, and availability.</p>
    <section><h2>Featured jacket</h2><img src="/demo-product.svg" /><button>Add jacket to basket</button></section>
    ...
    <section><h2>Stock alerts</h2><input type="email" placeholder="Your email" /><button>Notify me</button></section>
  </main>;
}
